  ...
  return (
    <div className="flex flex-col gap-2 text-neutral-600">
      ...
      {products.map((product) => (
        <div
          className="grid grid-cols-[ifr_3fr_1fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] text-xl items-center py-2 px-4 border"
          key={product._id}
        >
          <img
            className="w-14 h-20 object-cover border border-gray-300 rounded-md"
            src={product.image[0]}
